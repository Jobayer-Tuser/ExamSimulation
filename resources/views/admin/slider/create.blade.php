                            ...
                            <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-4">
                                        <fieldset class="form-group">
                                            ...
                                            <input name="title" type="text" class="form-control @error('title') is-invalid @enderror" id="image_title">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4">
                                        <fieldset class="form-group">
                                            ...
                                            <input name="target_link" type="text" class="form-control @error('target_link') is-invalid @enderror" id="target_link">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4">
                                        <fieldset class="form-group">
                                            ...
                                            <input name="sequence" type="number" class="form-control @error('sequence') is-invalid @enderror" id="sequence">
